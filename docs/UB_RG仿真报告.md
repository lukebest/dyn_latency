...
```
![exp1_dispatch_s2_hotcold_p99_vs_s.png](../results/ub_rg_packet/figures/exp1_dispatch_s2_hotcold_p99_vs_s.png)
![exp1_dispatch_s2_step_vs_batch.png](../results/ub_rg_packet/figures/exp1_dispatch_s2_step_vs_batch.png)
![exp1_dispatch_s2_throughput_vs_s.png](../results/ub_rg_packet/figures/exp1_dispatch_s2_throughput_vs_s.png)
### 2.3 场景3
**batch=16（256 尚未齐，暂用已有最大 batch） 对比表**
...
```
![exp1_dispatch_s3_hotcold_p99_vs_s.png](../results/ub_rg_packet/figures/exp1_dispatch_s3_hotcold_p99_vs_s.png)
![exp1_dispatch_s3_step_vs_batch.png](../results/ub_rg_packet/figures/exp1_dispatch_s3_step_vs_batch.png)
![exp1_dispatch_s3_throughput_vs_s.png](../results/ub_rg_packet/figures/exp1_dispatch_s3_throughput_vs_s.png)
...
```
![exp2_combine_s2_hotcold_p99_vs_s.png](../results/ub_rg_packet/figures/exp2_combine_s2_hotcold_p99_vs_s.png)
![exp2_combine_s2_step_vs_batch.png](../results/ub_rg_packet/figures/exp2_combine_s2_step_vs_batch.png)
![exp2_combine_s2_throughput_vs_s.png](../results/ub_rg_packet/figures/exp2_combine_s2_throughput_vs_s.png)
### 3.3 场景3
**batch=16（256 尚未齐，暂用已有最大 batch） 对比表**
...
```
![exp2_combine_s3_hotcold_p99_vs_s.png](../results/ub_rg_packet/figures/exp2_combine_s3_hotcold_p99_vs_s.png)
![exp2_combine_s3_step_vs_batch.png](../results/ub_rg_packet/figures/exp2_combine_s3_step_vs_batch.png)
![exp2_combine_s3_throughput_vs_s.png](../results/ub_rg_packet/figures/exp2_combine_s3_throughput_vs_s.png)
...
## 5. 方案对比摘要
- **场景1** 平均 step：UB_RG=263.4µs vs Spray=1066.9µs（Spray/RG=4.05×）
- **场景2** 平均 step：UB_RG=560.7µs vs Spray=570.2µs（Spray/RG=1.02×）
- **场景2** ub_rg CCT/König：mean=1.126，median=1.066
- **场景2** packet_spray CCT/König：mean=1.104，median=1.080
- **场景3** 平均 step：UB_RG=540.0µs vs Spray=821.7µs（Spray/RG=1.52×）
- **场景3** ub_rg CCT/König：mean=2.833，median=2.249
- **场景3** packet_spray CCT/König：mean=3.427，median=2.365
## 6. 双引擎对比（逐包 vs 行为级）
