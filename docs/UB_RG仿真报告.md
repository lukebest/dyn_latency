...
- **配置包输出差异**：Exp1 三方案共有参数格中，POP/RG 平均为 **1.003×**，Spray/RG 平均为 **1.239×**，POP2/RG 平均为 **1.013×**。这是当前配置包的联合差异；plane、path delay、jitter 和 barrier 尚未统一，不能把比值单独归因于目的侧配速（见 §1.1）。
- **POP 启动开销会被负载摊薄**：batch=16 时 POP/RG=**1.004×**，batch=256 时为 **1.000×**；结果符合“多一次 one-way 启动、稳态节拍与 RG 相同”的模型预期。
- **瓶颈下界**：CCT/König 中位数为 ub_rg=27.998、ub_rg_pop=27.998、ub_rg_pop2=21.088、packet_spray=8.715；它证明输出符合当前方程，但不是排除混杂后的硬件性能验证。
...
引擎：**packet**；成功汇总运行数：**695**。原始结果：`results/ub_rg_packet/`。
...
zipf_s
0.0          398.55  148.09    148.39     146.93       379.92  66.49     66.79      67.67       350.54  56.06     56.36      55.26       400.55  148.49    148.79     147.33        4717.10  12742.36  12716.39   12840.54
0.3         1979.08     NaN       NaN        NaN      1522.78    NaN       NaN        NaN       356.33    NaN       NaN        NaN      1981.08     NaN       NaN        NaN         950.14       NaN       NaN        NaN
0.7         9121.94     NaN       NaN        NaN       874.91    NaN       NaN        NaN       598.57    NaN       NaN        NaN      9123.94     NaN       NaN        NaN         206.13       NaN       NaN        NaN
0.9        13751.77     NaN       NaN        NaN       886.80    NaN       NaN        NaN      1048.25    NaN       NaN        NaN     13753.77     NaN       NaN        NaN         136.68       NaN       NaN        NaN
```
...
scheme packet_spray   ub_rg ub_rg_pop ub_rg_pop2 packet_spray  ub_rg ub_rg_pop ub_rg_pop2 packet_spray  ub_rg ub_rg_pop ub_rg_pop2 packet_spray   ub_rg ub_rg_pop ub_rg_pop2   packet_spray     ub_rg ub_rg_pop ub_rg_pop2
zipf_s
0.0          402.39  145.98    146.28     144.87       383.10  61.57     61.87      63.41       348.29  55.94     56.24      56.83       404.39  146.38    146.68     145.27        4673.27  12919.22  12892.54   13017.52
0.3          986.15     NaN       NaN        NaN       922.40    NaN       NaN        NaN       340.99    NaN       NaN        NaN       988.15     NaN       NaN        NaN        1905.46       NaN       NaN        NaN
0.7         2803.75     NaN       NaN        NaN       706.88    NaN       NaN        NaN       504.02    NaN       NaN        NaN      2805.75     NaN       NaN        NaN         670.19       NaN       NaN        NaN
0.9         3882.08     NaN       NaN        NaN       701.73    NaN       NaN        NaN       754.81    NaN       NaN        NaN      3884.08     NaN       NaN        NaN         484.03       NaN       NaN        NaN
```
...
## 6. 方案对比摘要
- **场景1** 平均 step（三方案共有参数格）：UB_RG=62.1µs vs POP=62.4µs（POP/RG=1.00×） vs Spray=202.9µs（Spray/RG=3.27×）
- **场景1** ub_rg CCT/König：mean=3.304，median=2.360
- **场景1** ub_rg_pop CCT/König：mean=3.331，median=2.401
- **场景1** ub_rg_pop2 CCT/König：mean=3.251，median=2.329
- **场景1** packet_spray CCT/König：mean=15.170，median=9.805
...
对齐样本 **2780** 组；step 比值（packet/behavioral）均值=111.560，中位数=7.786。
```
          exp  scenario       scheme     mode  batch  zipf_s  ep_size  step_packet  p99_packet  step_behav  p99_behav  step_ratio
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       63.330      49.767      11.855      7.131       5.342
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       63.330      49.767      20.058     14.955       3.157
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       63.330      49.767      28.936     25.646       2.189
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       63.330      49.767      51.752     48.319       1.224
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       67.030      49.045      11.855      7.131       5.654
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       67.030      49.045      20.058     14.955       3.342
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       67.030      49.045      28.936     25.646       2.316
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       67.030      49.045      51.752     48.319       1.295
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       70.499      47.114      11.855      7.131       5.947
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       70.499      47.114      20.058     14.955       3.515
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       70.499      47.114      28.936     25.646       2.436
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       70.499      47.114      51.752     48.319       1.362
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       77.670      42.200      11.855      7.131       6.552
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       77.670      42.200      20.058     14.955       3.872
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       77.670      42.200      28.936     25.646       2.684
exp1_dispatch         1 packet_spray dispatch     16     0.3      128       77.670      42.200      51.752     48.319       1.501
exp1_dispatch         1 packet_spray dispatch     16     0.7      128      200.486     151.847      24.901     19.030       8.051
exp1_dispatch         1 packet_spray dispatch     16     0.7      128      200.486     151.847      31.957     26.270       6.274
exp1_dispatch         1 packet_spray dispatch     16     0.7      128      200.486     151.847      40.384     34.656       4.965
exp1_dispatch         1 packet_spray dispatch     16     0.7      128      200.486     151.847      58.591     51.716       3.422
```
...
- **packet** 同参数格平均：POP/RG=1.002×，Spray/RG=1.232×
